    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                if(frecuenciaFundamental >=397 && frecuenciaFundamental <= 403)
                {
                    lblFrecuenciaFundamentaColor.Text = "rojo";
                }
                if (frecuenciaFundamental >= 797 && frecuenciaFundamental <= 803)
                {
                    lblFrecuenciaFundamentaColor.Text = "verde";
                }
                if (frecuenciaFundamental >= 1197 && frecuenciaFundamental <= 1203)
                {
                    lblFrecuenciaFundamentaColor.Text = "morado";
                }
                if (frecuenciaFundamental >= 1597 && frecuenciaFundamental <= 1603)
                {
                    lblFrecuenciaFundamentaColor.Text = "azul";
                }
                if (frecuenciaFundamental >= 1997 && frecuenciaFundamental <= 2003)
                {
                    lblFrecuenciaFundamentaColor.Text = "amarillo";
                }
